...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E007C 0x013F3F07 0x01010402
    ...
    mask_write 0XFF5E0080 0x013F3F07 0x01010402
    ...
    #  usually an issue, but designers must be aware.)
		...
		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E00C4, 0x013F3F07U ,0x01010A03U)  */
    mask_write 0XFF5E00C4 0x013F3F07 0x01010A03
		...
		# 6 bit divider
		# PSU_CRL_APB_PL2_REF_CTRL_DIVISOR0                                               0x9
    ...
    #  usually an issue, but designers must be aware.)
		...
		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E00C8, 0x013F3F07U ,0x01010900U)  */
    mask_write 0XFF5E00C8 0x013F3F07 0x01010900
		...
		# 6 bit divider
		# PSU_CRL_APB_PL3_REF_CTRL_DIVISOR0                                               0x2

		# 000 = IOPLL; 010 = RPLL; 011 = DPLL; (This signal may only be toggled af
    # ter 4 cycles of the old clock and 4 cycles of the new clock. This is not
    #  usually an issue, but designers must be aware.)
		# PSU_CRL_APB_PL3_REF_CTRL_SRCSEL                                                 0x3

		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E00CC, 0x013F3F07U ,0x01010203U)  */
    mask_write 0XFF5E00CC 0x013F3F07 0x01010203
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_mio_init_data {
    ...
    # Trace Port Databus)
		# PSU_IOU_SLCR_MIO_PIN_26_L3_SEL                                                  4

		# Configures MIO Pin 26 peripheral interface mapping
		#(OFFSET, MASK, VALUE)      (0XFF180068, 0x000000FEU ,0x00000080U)  */
    mask_write 0XFF180068 0x000000FE 0x00000080
    ...
    #  tracedq[8]- (Trace Port Databus)
		# PSU_IOU_SLCR_MIO_PIN_30_L3_SEL                                                  4

		# Configures MIO Pin 30 peripheral interface mapping
		#(OFFSET, MASK, VALUE)      (0XFF180078, 0x000000FEU ,0x00000080U)  */
    mask_write 0XFF180078 0x000000FE 0x00000080
    ...
    # ut) 7= trace, Output, tracedq[9]- (Trace Port Databus)
		# PSU_IOU_SLCR_MIO_PIN_31_L3_SEL                                                  4

		# Configures MIO Pin 31 peripheral interface mapping
		#(OFFSET, MASK, VALUE)      (0XFF18007C, 0x000000FEU ,0x00000080U)  */
    mask_write 0XFF18007C 0x000000FE 0x00000080
    ...
    mask_write 0XFF1800B0 0x000000FE 0x00000080
    ...
    mask_write 0XFF1800B4 0x000000FE 0x00000080
    ...
    mask_write 0XFF1800B8 0x000000FE 0x00000080
    ...
    mask_write 0XFF1800BC 0x000000FE 0x00000080
    ...
    mask_write 0XFF1800C0 0x000000FE 0x00000080
    ...
    mask_write 0XFF1800C4 0x000000FE 0x00000080
    ...
    # iver serial input) 7= Not Used
		# PSU_IOU_SLCR_MIO_PIN_50_L3_SEL                                                  2

		# Configures MIO Pin 50 peripheral interface mapping
		#(OFFSET, MASK, VALUE)      (0XFF1800C8, 0x000000FEU ,0x00000040U)  */
    mask_write 0XFF1800C8 0x000000FE 0x00000040
    ...
    # serial output) 7= Not Used
		# PSU_IOU_SLCR_MIO_PIN_51_L3_SEL                                                  2

		# Configures MIO Pin 51 peripheral interface mapping
		#(OFFSET, MASK, VALUE)      (0XFF1800CC, 0x000000FEU ,0x00000040U)  */
    mask_write 0XFF1800CC 0x000000FE 0x00000040
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x00000000
		...
		#(OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B00006U)  */
    mask_write 0XFF180208 0xFFFFFFFF 0x00B00006
...
set psu_afi_config {
    ...
    # modified during operation.
		#(OFFSET, MASK, VALUE)      (0XFD615000, 0x00000F00U ,0x00000400U)  */
    mask_write 0XFD615000 0x00000F00 0x00000400
}
