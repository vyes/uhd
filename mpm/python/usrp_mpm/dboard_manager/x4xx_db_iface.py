...
class TitaniumDboardIface(DboardIface):
    """
    Titanium DboardIface implementation
    ...
    def __init__(self, slot_idx, motherboard):
        super(TitaniumDboardIface, self).__init__(slot_idx, motherboard)
    ...
    def tear_down(self):
        ...
        super(TitaniumDboardIface, self).tear_down()
    ...
    def _find_converters(self, direction='both', channel='both'):
        ...
        """
        return self.mboard._find_converters(self.slot_idx, direction, channel)
    ...
    def set_if_freq(self, freq, direction='both', channel='both'):
        ...
        for tile_id, block_id, is_dac in self._find_converters(direction, channel):
            if not self.mboard._rfdc_ctrl.set_if(tile_id, block_id, is_dac, freq):
                return False
        return True
    ...
    def get_if_freq(self, direction, channel):
        ...
        return self.mboard._rfdc_ctrl.get_nco_freq(tile_id, block_id, is_dac)
    ...
    def enable_iq_swap(self, enable, direction, channel):
        ...
        """
        for tile_id, block_id, is_dac in self._find_converters(direction, channel):
            self.mboard._rfdc_regs.enable_iq_swap(enable, self.slot_idx, block_id, is_dac)
