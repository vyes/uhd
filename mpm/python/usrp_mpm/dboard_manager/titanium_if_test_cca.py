...
class TitaniumIfTestCCA(DboardManagerBase):
    """
    Holds all dboard specific information and methods of the Titanium IF Test CCA
    """
    #########################################################################
    # Overridables
    #
    ...
    def __init__(self, slot_idx, **kwargs):
        ...
        self.log = get_logger("TitaniumIfTestCCA-{}".format(slot_idx))
        self.log.trace("Initializing TitaniumIfTestCCA, slot index %d",
                       self.slot_idx)
