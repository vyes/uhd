...
class DebugDboardSignalPath:
    def __init__(self, slot_idx, path, adc_indexes, dac_indexes, loopback):
        self.log = get_logger("TitaniumDebugDboard-{}-path-{}".format(slot_idx, path))
...
class TitaniumDebugDboard(DboardManagerBase):
    """
    Holds all dboard specific information and methods of the Titanium debug dboard
    """
    #########################################################################
    # Overridables
    #
    ...
    def __init__(self, slot_idx, **kwargs):
        ...
        self.log = get_logger("TitaniumDebugDboard-{}".format(slot_idx))
        self.log.trace("Initializing TitaniumDebug daughterboard, slot index %d",
                       self.slot_idx)
