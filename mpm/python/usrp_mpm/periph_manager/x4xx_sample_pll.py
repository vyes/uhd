...
#
"""
LMK04832 driver for use with Titanium
"""

from usrp_mpm.chips import LMK04832
from usrp_mpm.sys_utils.gpio import Gpio

class LMK04832Titanium(LMK04832):
    """
    Titanium-specific subclass of the Sample Clock PLL LMK04832 controls.
    """
    ...
    def config(self, output_freq, brc_freq, is_legacy_mode=False):
        ...
        self.log.trace("Configuring SPLL to output frequency of {} Hz, used BRC frquency is {} Hz, legacy mode is {}"
                        .format(output_freq, brc_freq, is_legacy_mode))
