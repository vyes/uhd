...
#
"""
LMK03328 driver for use with Titanium
"""
...
class LMK03328Titanium(LMK03328):
    """
    Titanium-specific subclass of the Reference Clock PLL LMK03328 controls.
    """
    ...
    def config(self, ref_select=2, brc_rate=25e6, usr_clk_rate=156.25e6, brc_select='PLL'):
        ...
        elif not self.check_pll_locked(2):
