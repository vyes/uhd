...
def do_update_cpld(filename, updater_mode):
    ...
    """
    logger = get_logger('update_cpld')
    logger.info("Programming CPLD of mboard with image {} using {} mode".format(filename, updater_mode))
    ...
    if updater_mode == 'legacy':
        ...
        logger.error("Invalid updater method {} given".format(update_mode))
        return False
...
def main():
    ...
    def parse_args():
        ...
        parser.add_argument("--file", help="Filename of CPLD image",
                            default="/lib/firmware/ni/cpld-titanium.rpd")
