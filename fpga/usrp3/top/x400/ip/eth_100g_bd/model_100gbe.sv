...
//
// Module: model_100gbe
// Description: A wrapper of the 100gbe core to axistream interface.
//  this model can be used drive packets into the x400 translated to
//  serial ethernet.  This is generally pretty slower than just
//  driving things in at the output of the mac.
package Pkg100gbMac;
  import PkgAxiLite::*;
