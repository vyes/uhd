...
//
//     eop is specifically inspected in a 4in,4out function to find a pseudo one hot.
//     this is unrotated along with enable, and combined with datavalid to determine
//     the next pop, which controls incrementing of the rd_pointer.
//---------------------------------------------
