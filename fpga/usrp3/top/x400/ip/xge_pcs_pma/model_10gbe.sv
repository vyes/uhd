...
//
// Module: model_10gbe
// Description: A wrapper of the 10gbe core to axistream interface.
//  this model can be used drive packets into the x400 translated to
//  serial ethernet.  This is far slower than just driving things in
//  at the output of the mac with force's
module model_10gbe  #(
