...
#   MGT_REFCLK_LMK[0]  |  161.1328125 MHz  |  25 GbE / Aurora
#   MGT_REFCLK_LMK[1]  |  100.0000000 MHz  |  PCIe
#   MGT_REFCLK_LMK[2]  |  156.2500000 MHz  |  10/100 GbE
#   MGT_REFCLK_LMK[3]  |  125.0000000 MHz  |  1 GbE
#
######################################################################
...
set_property IOSTANDARD LVCMOS12 [get_ports {QSFP*_LPMODE_n}]

set_property SLEW SLOW [get_ports {QSFP*_MODPRS_n}]
set_property SLEW SLOW [get_ports {QSFP*_RESET_n}]
set_property SLEW SLOW [get_ports {QSFP*_LPMODE_n}]
...
######################################################################
# Pin constraints for the other PL pins
######################################################################
...
set_property IOSTANDARD LVCMOS12 [get_ports {PL_CPLD_IRQ FPGA_TEST PPS_LED}]
...
set_property IOSTANDARD LVCMOS12 [get_ports {PL_CPLD_JTAGEN PL_CPLD_CS*_n TDC_SPARE_* CPLD_JTAG_OE_n}]
