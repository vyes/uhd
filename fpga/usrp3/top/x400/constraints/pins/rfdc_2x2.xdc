...
#   RF Data Converter Block - 2 X 2 implementation
#
# NOTE: the constraints commented out are not used in the
#       above listed implementation, comments were left for
#       unused-ports reference.
#
...
# Note: numbering here does NOT match schematic, but it is
#       the right order according to RF BD Connection spec.
