...
//  This must match the LO_SELECT values in gen_zrcpld_regs.py
enum class zbx_lo_t {
    TX0_LO1 = 0,
    TX0_LO2 = 1,
    TX1_LO1 = 2,
...
//  | min_band_freq | max_band_freq | rf_fir | if1_fir | if2_fir | mix1 m, n | mix2 m, n | max_bandwidth | if1_freq_min | if1_freq_max | if2_freq_min | if2_freq_max |
    {      1e6,          200e6,          1,       1,        2,      -1,  1,     -1,  1,         80e6,         4100e6,        4100e6,        1850e6,        1850e6    },
    {    200e6,          400e6,          1,       1,        2,      -1,  1,     -1,  1,        100e6,         4100e6,        4100e6,        1850e6,        1850e6    },
    {    400e6,          500e6,          1,       1,        2,      -1,  1,     -1,  1,        100e6,         4100e6,        4100e6,        1850e6,        1850e6    },
    {    500e6,          900e6,          1,       1,        2,      -1,  1,     -1,  1,        400e6,         4100e6,        4100e6,        1850e6,        1850e6    },
    {    900e6,         1800e6,          1,       1,        2,      -1,  1,     -1,  1,        400e6,         4100e6,        4100e6,        2150e6,        2150e6    },
    {   1800e6,         2300e6,          2,       1,        1,      -1,  1,     -1,  1,        400e6,         4100e6,        4100e6,        1060e6,        1060e6    },
    {   2300e6,         2700e6,          3,       1,        1,      -1,  1,     -1,  1,        400e6,         4100e6,        3700e6,        1060e6,        1060e6    },
    {   2700e6,         3000e6,          3,       4,        2,       1, -1,      1, -1,        400e6,         7000e6,        7100e6,        2050e6,        2050e6    },
    {   3000e6,         4200e6,          0,       1,        2,       0,  0,     -1,  1,        400e6,              0,             0,        1850e6,        1850e6    },
    {   4200e6,         4500e6,          0,       2,        2,       0,  0,     -1,  1,        400e6,              0,             0,        1850e6,        1850e6    },
    {   4500e6,         4700e6,          0,       2,        1,       0,  0,     -1,  1,        400e6,              0,             0,        1060e6,        1060e6    },
    {   4700e6,         5300e6,          0,       2,        1,       0,  0,     -1,  1,        400e6,              0,             0,        1060e6,        1060e6    },
    {   5300e6,         5600e6,          0,       2,        1,       0,  0,      1, -1,        400e6,              0,             0,        1060e6,        1060e6    },
    {   5600e6,         6800e6,          0,       3,        1,       0,  0,      1, -1,        400e6,              0,             0,        1060e6,        1060e6    },
    {   6800e6,         7400e6,          0,       4,        1,       0,  0,      1, -1,        400e6,              0,             0,        1060e6,        1060e6    },
    {   7400e6,         8000e6,          0,       4,        2,       0,  0,      1, -1,        400e6,              0,             0,        1850e6,        1850e6    },
};

static const std::vector<tune_map_item_t> tx_tune_map = {
//  | min_band_freq | max_band_freq | rf_fir | if1_fir | if2_fir | mix1 m, n | mix2 m, n | max_bandwidth | if1_freq_min | if1_freq_max | if2_freq_min | if2_freq_max |
    {      1e6,          200e6,          1,       2,        1,      -1,  1,      1, -1,         80e6,         4600e6,        4600e6,        1060e6,        1060e6    },
    {    200e6,          300e6,          1,       2,        1,      -1,  1,      1, -1,        100e6,         4600e6,        4600e6,        1060e6,        1060e6    },
    {    300e6,          400e6,          1,       2,        1,      -1,  1,      1, -1,        100e6,         4600e6,        4600e6,        1060e6,        1060e6    },
    {    400e6,          600e6,          1,       2,        1,      -1,  1,      1, -1,        100e6,         4600e6,        4600e6,        1060e6,        1060e6    },
    {    600e6,          800e6,          1,       2,        1,      -1,  1,      1, -1,        200e6,         4600e6,        4600e6,        1060e6,        1060e6    },
    {    800e6,         1300e6,          1,       2,        1,      -1,  1,      1, -1,        400e6,         4600e6,        4600e6,        1060e6,        1060e6    },
    {   1300e6,         1800e6,          1,       2,        1,      -1,  1,      1, -1,        400e6,         4600e6,        4600e6,        1060e6,        1060e6    },
    {   1800e6,         2300e6,          2,       1,        1,      -1,  1,     -1,  1,        400e6,         4100e6,        4100e6,        1060e6,        1060e6    },
    {   2300e6,         2700e6,          3,       1,        2,      -1,  1,     -1,  1,        400e6,         3700e6,        3700e6,        2070e6,        2200e6    },
    {   2700e6,         3000e6,          3,       5,        2,       1, -1,      1, -1,        400e6,         6800e6,        7100e6,        2000e6,        2000e6    },
    {   3000e6,         4030e6,          0,       1,        2,       0,  0,     -1,  1,        400e6,              0,             0,        2050e6,        2370e6    },
    {   4030e6,         4500e6,          0,       1,        1,       0,  0,     -1,  1,        400e6,              0,             0,        1060e6,        1060e6    },
    {   4500e6,         4900e6,          0,       2,        1,       0,  0,      1, -1,        400e6,              0,             0,        1060e6,        1060e6    },
    {   4900e6,         5100e6,          0,       2,        1,       0,  0,      1, -1,        400e6,              0,             0,        1060e6,        1060e6    },
    {   5100e6,         5700e6,          0,       3,        2,       0,  0,      1, -1,        400e6,              0,             0,        1900e6,        2300e6    },
    {   5700e6,         6100e6,          0,       4,        2,       0,  0,      1, -1,        400e6,              0,             0,        2300e6,        2500e6    },
    {   6100e6,         6400e6,          0,       4,        2,       0,  0,      1, -1,        400e6,              0,             0,        2400e6,        2500e6    },
    {   6400e6,         7000e6,          0,       5,        2,       0,  0,      1, -1,        400e6,              0,             0,        1900e6,        1950e6    },
    {   7000e6,         7400e6,          0,       6,        1,       0,  0,      1, -1,        400e6,              0,             0,        1060e6,        1060e6    },
    {   7400e6,         8000e6,          0,       6,        2,       0,  0,      1, -1,        400e6,              0,             0,        1950e6,        2050e6    },
};
